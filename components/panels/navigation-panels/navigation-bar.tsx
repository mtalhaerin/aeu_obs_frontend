...
const NavigationBar: React.FC<NavigationBarProps> = ({
  ...
  const getImgSrc = (source: string | ImageSourcePropType): string => {
    ...
    try {
      ...
      return (
        resolved?.uri ?? (source as any)?.uri ?? (source as any)?.default ?? ""
      );
    } catch (_e) {
  ...
  const isSvg =
    resolvedSrc.toLowerCase().endsWith(".svg") || resolvedSrc.includes("svg");
    ...
    <View style={styles.container}>
      <Pressable style={styles.leftSection} onPress={handleLogoClick}>
        {!logoLoadFailed && logoSrc ? (
          ...
          <Text style={[styles.logo, styles.notSelectable]} selectable={false}>
            AEU OBS
          </Text>
        )}
      </Pressable>
      ...
      <View style={styles.rightSection}>
        <View style={styles.profileContainer}>
          <Pressable style={styles.profileButton} onPress={handleProfileClick}>
            <Text
              style={[styles.profileName, styles.notSelectable]}
              selectable={false}
            >
              {displayName}
            </Text>
            ...
            <View style={styles.profileImage}>
              <Text
                style={[styles.profileImageText, styles.notSelectable]}
                selectable={false}
              >
                {avatarInitial}
              </Text>
          ...
          {isDropdownOpen && (
            <View style={styles.dropdown}>
              ...
              >
                <Text
                  style={[styles.dropdownText, styles.notSelectable]}
                  selectable={false}
                >
                  Profil
                </Text>
              ...
              <Pressable
                style={[
                  styles.dropdownItem,
                  hoveredDropdownItem === "notifications" &&
                    styles.dropdownItemHovered,
                ]}
                onPress={() => setIsDropdownOpen(false)}
                {...(Platform.OS === "web" &&
